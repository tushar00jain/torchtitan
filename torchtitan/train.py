...
class Trainer(torch.distributed.checkpoint.stateful.Stateful):
    ...
    def train_step(
        ...
        global_avg_loss, global_max_loss, global_ntokens_seen = (
            self.compute_global_losses(parallel_dims, loss)
        )
    ...
    def compute_global_losses(
        self, parallel_dims: ParallelDims, loss: torch.Tensor
    ) -> torch.Tensor:
        ...
        if parallel_dims.dp_cp_enabled:
            ...
            return (
                dist_utils.dist_sum(loss, loss_mesh, None),
                dist_utils.dist_max(loss, loss_mesh, None),
                dist_utils.dist_sum(
                    torch.tensor(
